// js/script.js
import { BalanceTable } from './components/BalanceTable.js'; // Import du composant BalanceTable
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ---  Exemple d'appel initial à initWebSocket (pourrait être déclenché ailleurs selon la logique de votre application) ---
    window.initWebSocket(); // Initialiser WebSocket  - DEPLACER L'APPEL VERS dashboard.js (ou autre endroit plus logique si on modularise davantage)
